...
/**
 * <p>BenutzerVerwaltungAdmin-Testklasse</p>
 * <p>Diese Klasse testet die Klasse BenutzerVerwaltungAdmin</p>
 */
class BenutzerVerwaltungAdminTest {
  ...
  void benutzerEintragen() {
    ...
    try {
      ...
      fail("Benutzer noch nicht in Liste.");
    }
  ...
  void benutzerLöschen() {
    ...
    try {
      ...
      fail("Benutzer ist in Liste.");
    }
    try {
      verwaltung.benutzerLöschen(benutzer2);
      fail("Benutzer nicht in Liste.");
    } catch (BenutzerNichtInListeException e) {
    }
  }
  ...
  void benutzerLöschenInit() {
    ...
    try {
      verwaltung.benutzerLöschen(benutzer1);
      fail("Benutzer nicht in Liste, da initialisiert.");
    } catch (BenutzerNichtInListeException e) {
    }
  }
}